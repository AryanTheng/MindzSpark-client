    ...
    return (
        <div>
            <div className='container mx-auto p-2 flex items-center justify-between gap-4'>
                ...
                <Link
                  to={redirectURL}
                  className="text-green-600 font-semibold flex items-center gap-1 hover:underline hover:text-green-700 transition"
                >
                  See All
                  <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" className="inline-block"><path d="M5 12l5-5-5-5"/></svg>
                </Link>
            </div>
