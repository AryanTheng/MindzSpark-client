...
import { MdLocationOn, MdSupport, MdNotifications } from 'react-icons/md';
...
const Header = () => {
  ...
  const totalCartItems = cartItem?.reduce((total, item) => total + item.quantity, 0) || 0;

  // Custom click away implementation
  useEffect(() => {
      ...
      >
        ...
        <div className="bg-gray-900 text-white text-sm hidden md:block">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between py-2 space-y-2 md:space-y-0">
              <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
                <a 
                  href="tel:+917397901889"
                ...
                <div className="flex items-center space-x-2">
                  <MdLocationOn className="text-green-400 flex-shrink-0" size={16} />
              ...
              <div className="flex items-center space-x-4">
                <div className="relative">
                  <button 
                    onClick={toggleTrackOrder}
                    className="flex items-center space-x-1 hover:text-green-400 transition-colors"
                  >
                    <BsTruck className="text-green-400 flex-shrink-0" size={14} />
                      ...
                      <div className="px-4 py-2">
                        <form onSubmit={handleTrackOrder} className="space-y-2">
                          <input
                            ...
                            className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                            required
                          />
                          <button
                            type="submit"
                ...
                <div className="relative">
                  <button 
                    ...
                    className="flex items-center space-x-1 hover:text-green-400 transition-colors"
                  >
                    <MdSupport className="text-green-400 flex-shrink-0" size={16} />
                    <span>Support</span>
                    <svg 
                      className={`w-4 h-4 ml-1 transition-transform duration-200 ${openSupport ? 'transform rotate-180' : ''}`}
                      fill="none" 
                      stroke="currentColor" 
                      viewBox="0 0 24 24" 
                  ...
                  {openSupport && (
                    <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-md shadow-lg py-1 z-50">
                      <div className="px-4 py-2">
